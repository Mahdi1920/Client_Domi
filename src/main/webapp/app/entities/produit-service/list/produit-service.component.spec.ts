...
describe('Component Tests', () => {
  describe('ProduitService Management Component', () => {
    let comp: ProduitServiceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProduitServiceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.produitServices[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
