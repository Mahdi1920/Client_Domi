...
export class ProduitServiceService {
  ...
  getProduits(): Observable<IProduitService[]>{
    return this.http.get<IProduitService[]>(`${this.UrlApi}/api/produits`);
  }
  ...
  find(CODE_PRODUIT_SERVICE: number): Observable<EntityResponseType> {
    return this.http.get<IProduitService>(`${this.resourceUrl}/${CODE_PRODUIT_SERVICE}`, { observe: 'response' });
  }
